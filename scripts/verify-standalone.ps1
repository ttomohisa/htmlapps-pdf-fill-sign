...
# Full standalone outputs must carry the canonical app icon in both locations.
# The repository regression fixture can opt out because it intentionally tests only placeholder semantics.
